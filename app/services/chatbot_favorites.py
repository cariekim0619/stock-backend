...
class ChatbotFavorites:
    ...
    def format_summary_carousel_for_kakao(
        ...
        web_url = card1.get("web_url", f"https://securities.koreainvestment.com/app/mtsrenewal.jsp?type=06&SSO_SCREENNO=0800")
                                    ...
                                    "buttons": [
                                        {
                                            "action": "webLink",
                                            "label": "거래내역 자세히 보기",
                                            "webLinkUrl": f"https://securities.koreainvestment.com/app/mtsrenewal.jsp?type=06&SSO_SCREENNO=0800",
                                        }
                                    ],
                                },
                            ],
